...
*??  test_free_list_extension - 已移至 eflash_ftl_tests_extension.c 独立测试
*/
...
static int test_gc_basic(void);
static int test_gc_round_wrap(void);
static int test_gc_stress(void);
